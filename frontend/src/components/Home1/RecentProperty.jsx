  ...
  return (
    <div className="text-center bg-white p-6 overflow-x-hidden">
      <div className="flex justify-center">
        ...
        <h1 className="text-3xl lg:text-4xl font-bold mb-2 mt-9">Recent Properties</h1>
        <span className="hidden lg:block w-60 mt-14 ml-4 border-t text-gray-400" />
      </div>

      <p className="text-gray-600 lg:text-xl mb-6"> exclusive properties by our team.</p>
